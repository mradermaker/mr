...
function mr_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'mr_content_width', 640 );
}
...
function mr_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'mr' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'mr' ),
...
function mr_scripts() {
	...
	wp_enqueue_script( 'mr-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
